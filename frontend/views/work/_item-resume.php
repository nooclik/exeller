...
<ul class="request-product_list">
    <li>
        <div class="product-row-title row">
            <div class="col-title col-md-10"><?= Html::a($model->post, ['work/view-resume', 'id' => $model->id]) ?></div>
            <div class="col-price col-md-2"><span class="label-price"><?= $model->salary ?>
                    руб.</span></div>
        </div>
        <div class="product-row-data row">
            ...
            <div class="col-md-6 col-adres">
                ...
                <p class="label-adres"><?= $model->city ?></p>
            </div>
        </div>
    </li>
</ul>